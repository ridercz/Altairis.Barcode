...
namespace Altairis.Barcode {
    public abstract class Code39Generator : Generator {
        private System.Collections.Generic.Dictionary<char, int> codeTable;
        ...
        private void PopulateCodeTable() {
            char[] codeChars = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%*".ToCharArray();
            int[] codeValues = new int[] { 0x0a6d, 0x0d2b, 0x0b2b, 0x0d95, 0x0a6b, 0x0d35, 0x0b35, 0x0a5b, 0x0d2d, 0x0b2d, 0x0d4b, 0x0b4b, 0x0da5, 0x0acb, 0x0d65, 0x0b65, 0x0a9b, 0x0d4d, 0x0b4d, 0x0acd, 0x0d53, 0x0b53, 0x0da9, 0x0ad3, 0x0d69, 0x0b69, 0x0ab3, 0x0d59, 0x0b59, 0x0ad9, 0x0cab, 0x09ab, 0x0cd5, 0x096b, 0x0cb5, 0x09b5, 0x095b, 0x0cad, 0x09ad, 0x0925, 0x0929, 0x0949, 0x0a49, 0x096d };
        ...
        public override void DrawTo(System.Drawing.Graphics g, System.Drawing.Point position) {
            ...
            foreach (char c in this.EncodedContent) {
                int code = this.codeTable[c];
